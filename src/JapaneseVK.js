...
class Callback {
   ...
   populateMenu(menu) {
      ...
      if(this.page_number > 0) {
         const pageUp = $(`<button class="pageup">&#x2BC5;<span class="border rounded ms-1"><kbd>PgUp</<kbd></span></button>`);
      ...
      if((this.page_number + 1) * disp_number < this.word_lists[this.list_index].length) {
         const pageDn = $(`<button class="pagedown">&#x2BC6;<span class="border rounded ms-1"><kbd>PgDn</<kbd></span></button>`);
